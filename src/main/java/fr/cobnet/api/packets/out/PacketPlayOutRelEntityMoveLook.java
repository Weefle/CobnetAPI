 ...
 */
public class PacketPlayOutRelEntityMoveLook extends SentPacket {

    public PacketPlayOutRelEntityMoveLook(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.REL_ENTITY_MOVE_LOOK;
    }
