 ...
 */
public class PacketPlayOutHeldItemSlot extends SentPacket {

    public PacketPlayOutHeldItemSlot(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.HELD_ITEM_SLOT;
    }
