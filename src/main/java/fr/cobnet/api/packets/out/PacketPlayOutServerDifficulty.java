 ...
 */
public class PacketPlayOutServerDifficulty extends SentPacket {

    public PacketPlayOutServerDifficulty(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SERVER_DIFFICULTY;
    }
