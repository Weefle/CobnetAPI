 ...
 */
public class PacketPlayOutWorldParticles extends SentPacket {

    public PacketPlayOutWorldParticles(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.WORLD_PARTICLES;
    }
