 ...
 */
public class PacketPlayOutEntityStatus extends SentPacket {

    public PacketPlayOutEntityStatus(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_STATUS;
    }
