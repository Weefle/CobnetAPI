 ...
 */
public class PacketPlayOutMultiBlockChange extends SentPacket {

    public PacketPlayOutMultiBlockChange(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.MULTI_BLOCK_CHANGE;
    }
