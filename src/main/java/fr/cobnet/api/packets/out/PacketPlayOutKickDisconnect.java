 ...
 */
public class PacketPlayOutKickDisconnect extends SentPacket {

    public PacketPlayOutKickDisconnect(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.KICK_DISCONNECT;
    }
