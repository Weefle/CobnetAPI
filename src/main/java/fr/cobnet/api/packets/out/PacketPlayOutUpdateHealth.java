 ...
 */
public class PacketPlayOutUpdateHealth extends SentPacket {

    public PacketPlayOutUpdateHealth(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.UPDATE_HEALTH;
    }
