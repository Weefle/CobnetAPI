 ...
 */
public class PacketPlayOutSpawnPosition extends SentPacket {

    public PacketPlayOutSpawnPosition(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SPAWN_POSITION;
    }
