 ...
 */
public class PacketPlayOutSetCompression extends SentPacket {

    public PacketPlayOutSetCompression(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SET_COMPRESSION;
    }
