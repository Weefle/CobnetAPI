 ...
 */
public class PacketPlayOutEntityVelocity extends SentPacket {

    public PacketPlayOutEntityVelocity(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_VELOCITY;
    }
