 ...
 */
public class PacketPlayOutEntityHeadRotation extends SentPacket {

    public PacketPlayOutEntityHeadRotation(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_HEAD_ROTATION;
    }
