 ...
 */
public class PacketPlayOutUpdateEntityNBT extends SentPacket {

    public PacketPlayOutUpdateEntityNBT(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.UPDATE_ENTITY_NBT;
    }
