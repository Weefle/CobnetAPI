 ...
 */
public class PacketPlayOutGameStateChange extends SentPacket {

    public PacketPlayOutGameStateChange(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.GAME_STATE_CHANGE;
    }
