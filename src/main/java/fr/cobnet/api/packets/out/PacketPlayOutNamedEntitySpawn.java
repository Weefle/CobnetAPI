 ...
 */
public class PacketPlayOutNamedEntitySpawn extends SentPacket {

    public PacketPlayOutNamedEntitySpawn(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.NAMED_ENTITY_SPAWN;
    }
