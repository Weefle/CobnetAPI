 ...
 */
public class PacketPlayOutEntityDestroy extends SentPacket {

    public PacketPlayOutEntityDestroy(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_DESTROY;
    }
