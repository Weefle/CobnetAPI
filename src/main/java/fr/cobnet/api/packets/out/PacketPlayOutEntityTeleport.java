 ...
 */
public class PacketPlayOutEntityTeleport extends SentPacket {

    public PacketPlayOutEntityTeleport(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_TELEPORT;
    }
