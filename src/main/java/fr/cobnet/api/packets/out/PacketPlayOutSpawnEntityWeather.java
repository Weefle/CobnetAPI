 ...
 */
public class PacketPlayOutSpawnEntityWeather extends SentPacket {

    public PacketPlayOutSpawnEntityWeather(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SPAWN_ENTITY_WEATHER;
    }
