 ...
 */
public class PacketPlayOutEntityEffect extends SentPacket {

    public PacketPlayOutEntityEffect(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_EFFECT;
    }
