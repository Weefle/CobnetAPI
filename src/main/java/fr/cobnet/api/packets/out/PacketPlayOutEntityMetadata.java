 ...
 */
public class PacketPlayOutEntityMetadata extends SentPacket {

    public PacketPlayOutEntityMetadata(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_METADATA;
    }
