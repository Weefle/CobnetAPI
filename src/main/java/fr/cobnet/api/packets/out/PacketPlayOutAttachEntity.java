 ...
 */
public class PacketPlayOutAttachEntity extends SentPacket {

    public PacketPlayOutAttachEntity(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ATTACH_ENTITY;
    }
}
