 ...
 */
public class PacketPlayOutTileEntityData extends SentPacket {

    public PacketPlayOutTileEntityData(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.TILE_ENTITY_DATA;
    }
