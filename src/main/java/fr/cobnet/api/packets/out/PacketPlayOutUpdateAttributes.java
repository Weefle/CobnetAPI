 ...
 */
public class PacketPlayOutUpdateAttributes extends SentPacket {

    public PacketPlayOutUpdateAttributes(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.UPDATE_ATTRIBUTES;
    }
