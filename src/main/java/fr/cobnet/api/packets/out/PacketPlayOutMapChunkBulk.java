 ...
 */
public class PacketPlayOutMapChunkBulk extends SentPacket {

    public PacketPlayOutMapChunkBulk(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.MAP_CHUNK_BULK;
    }
