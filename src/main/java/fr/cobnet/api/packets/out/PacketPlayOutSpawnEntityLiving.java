 ...
 */
public class PacketPlayOutSpawnEntityLiving extends SentPacket {

    public PacketPlayOutSpawnEntityLiving(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SPAWN_ENTITY_LIVING;
    }
