 ...
 */
public class PacketPlayOutCustomPayload extends SentPacket {

    public PacketPlayOutCustomPayload(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.CUSTOM_PAYLOAD;
    }
