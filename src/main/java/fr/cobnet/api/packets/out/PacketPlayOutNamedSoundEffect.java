 ...
 */
public class PacketPlayOutNamedSoundEffect extends SentPacket {

    public PacketPlayOutNamedSoundEffect(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.NAMED_SOUND_EFFECT;
    }
