 ...
 */
public class PacketPlayOutEntityEquipment extends SentPacket {

    public PacketPlayOutEntityEquipment(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.ENTITY_EQUIPMENT;
    }
