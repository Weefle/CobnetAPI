 ...
 */
public class PacketPlayOutScoreboardTeam extends SentPacket {

    public PacketPlayOutScoreboardTeam(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SCOREBOARD_TEAM;
    }
