 ...
 */
public class PacketPlayOutScoreboardScore extends SentPacket {

    public PacketPlayOutScoreboardScore(Packet<?> packet, Player player) {
        super(packet, player);
    }

    @Override
    public OutPacketType getType() {
        return OutPacketType.SCOREBOARD_SCORE;
    }
